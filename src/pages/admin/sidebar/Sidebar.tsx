    ...
    <aside className="sidebar">
        <ul className="sidebar-menu">
            <li className="menu-item">
                ...
                <NavLink className={({isActive}) => isActive ? "sidebar-menu__link sidebar-menu__link--active" : "sidebar-menu__link"} to={"/admin/admin-vacancies"}><i className="icon"><MdOutlinePersonSearch/></i>Vakansiyalar</NavLink>
            </li>
            <li className="menu-item">
